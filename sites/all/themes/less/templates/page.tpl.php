...
<header  role="navigation" class="navbar navbar-inverse">
 <div class="navbar-header header"> 
                <div class="col-lg-12">
                  <h1><a href="/"><?php if (!empty($site_name)): ?>
        <?php print $site_name; ?>
      <?php endif; ?>
</a></h1> 
...
<div class="main-container <?php print $container_class; ?>">
  ...
  <?php //echo $message_not; вот тут не выводит?>
<form accept-charset="UTF-8" id="user-login-form" method="post" action="/node?destination=node">

                <div class="form-group">
                  <input type="text"  class="form-control input-lg" placeholder="Логин" name="name" id="edit-name">
                </div>
                <div class="form-group">
        ...
        <input type="hidden" value="" name="form_build_id">
                ...
                <button type="submit" class="btn btn-warning pull-right" value="Войти" name="op" id="edit-submit">вход</button>
